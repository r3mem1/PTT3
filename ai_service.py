...
Для слайда типа "section" (разделитель) заполни только "title" — без bullets,
без цитаты и атрибуции. Если нужна именно ЦИТАТА с атрибуцией — используй
"type": "section", "layout": "quote", "title" = сам текст цитаты, "subtitle" =
имя автора.
